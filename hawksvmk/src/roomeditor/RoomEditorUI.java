        ...
        saveRoomButton.addActionListener(new ActionListener()
        {
        	public void actionPerformed(ActionEvent ae)
        	{
        	    ...
        	    if(returnVal == JFileChooser.APPROVE_OPTION)
        	    {
        	    	...
        	    	// write the file out
        	    	FileOperations.saveFile(filename, theGridView.getBackgroundImagePath(), theGridView.getRoomInfo(), theGridView.getTilesMap(), theGridView.getAnimations(), theGridView.getSounds(), theGridView.getRoomItems(), theGridView.getClickableAreas(), theGridView.getGridObjects(), theGridView.getTileSize());
